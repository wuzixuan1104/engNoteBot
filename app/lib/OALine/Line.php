...
class Bot {
  ...
  public function replyMessage($replyToken, Message $message) {
    ...
    return $message ? $this->curl->post($this->endpointBase . '/v2/bot/message/reply', [
      'replyToken' => $replyToken,
      'messages' => $message->buildMessage(),
    ]) : false;
  }

  public function replyMessages($replyToken, array $messages) {
    return $messages ? $this->curl->post($this->endpointBase . '/v2/bot/message/reply', [
      'replyToken' => $replyToken,
      'messages' => call_user_func_array('array_merge', array_filter(array_map( function($message) {
  ...
  public function pushMessages(array $tos, array $messages) {
...
abstract class Message {
  ...
  public static function pushMulTo($sources, array $messages) {
    ...
    return !empty($sids) ? Bot::instance()->pushMessages($sids, $messages)->isSucceeded : false;
  }

  public function replyTo($replyToken) {
    return Bot::instance()->replyMessage($replyToken, $this)->isSucceeded;
  }
