...
class Generator {
  ...
  public static function create($filePath = '/Users/wuzixuan/www/TripSaaS/crm_linebot/asset/img/richmenu/v2.png') {
    if(!$richMenu = Bot::instance()->createRichMenu(Richmenu::create(
      RichmenuSize::getHalf(), true, '旅遊咖 : ' . date('Y-m-d H:i:s'), '來去旅遊摟 GO!',
      [ 
        RichmenuArea::create(RichmenuAreaBounds::create(0, 0, 1250, 843), RichmenuAction::uri('已點擊「 聯絡客服 」', 'line://app/1555845100-rzbpDjN5')),
        RichmenuArea::create(RichmenuAreaBounds::create(1251, 0, 1250, 843), RichmenuAction::postback('訂單查詢', ['order'], '已點擊「 訂單查詢 」')),
      ]
    )))
      return false;
